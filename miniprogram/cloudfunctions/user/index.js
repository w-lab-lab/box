...
const registerperssion = db.collection('register')
...
exports.main = async (event, context) => {
  ...
  // 获取用户信息
  app.router('getUserInfoByUserId', async (ctx, next) => {
  ...
  //获取许可
  app.router('getpermission', async (ctx, next) => {
    try {
      ctx.body = await registerperssion
        .field({
          _id: false,
          permission: true
        })
